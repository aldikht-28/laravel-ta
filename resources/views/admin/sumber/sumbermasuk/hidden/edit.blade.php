...
@section('tittle', 'Edit Sumber Arus Kas Masuk')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ubah Data Sumber Arus Kas Masuk</h1>
    </div>
    <form action="/sumbermasuk/{{ $sumbermasuk->id }}" method="POST">
        @csrf
        @method('PATCH')
        <div class="mb-3 col-lg-6">
            <label class="form-label" for="nama">Nama Sumber Arus Kas Masuk</label>
            <input type="text" class="form-control" id="nama" name="nama" value="{{ $sumbermasuk->nama }}">
            @error('nama')
