...
@section('tittle', 'Laporan Arus Kas TPQ')
@section('laptpq', 'active')
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Laporan Arus Kas TPQ</h1>
            @if ($awal)
                <a href="/laptpqpdf/{{ $awal }}/{{ $akhir }}" class="btn btn-sm btn-danger mt-3"><i
                        class="fa-solid fa-download"></i> Download PDF
                </a>
            @else
                <a href="/laptpqpdf" class="btn btn-sm btn-danger mt-3"><i class="fa-solid fa-download"></i> Download PDF
                </a>
            @endif
        </div>
        <div class="col-md-10 mb-4">
            <form action="{{ route('carilaporantpq') }}" method="POST" role="carilaporantpq">
                <br>
                @csrf
                <div class="container">
                    <div class="row g-2">
