...
@section('tittle', 'Laporan Arus Kas PAUD')
@section('lappaud', 'active')
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Laporan Arus Kas PAUD</h1>
            @if ($awal)
                <a href="/lappaudpdf/{{ $awal }}/{{ $akhir }}" class="btn btn-sm btn-danger mt-3"><i
                        class="fa-solid fa-download"></i> Download PDF
                </a>
            @else
                <a href="/lappaudpdf" class="btn btn-sm btn-danger mt-3"><i class="fa-solid fa-download"></i> Download PDF
            @endif
            </a>
        </div>
        <div class="col-md-10 mb-4">

            <form action="{{ route('carilaporanpaud') }}" method="POST" role="carilaporanpaud">
                <br>
                @csrf
                <div class="container">
                    <div class="row g-2">
                        ...
                        <div class="col-sm-2 ">
                            <button type="submit" name="cari" title="Cari" class="btn btn-success"><i
